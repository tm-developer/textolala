...
<!--[if gt IE 8]><!--><html class="no-js" <?php language_attributes() ?>><!--<![endif]-->
    ...
    <body <?php body_class() ?> id="<?php if (is_page('home')) { echo "home"; }elseif( is_category()){$category = get_the_category(); echo $category[0]->slug;}elseif( is_single()){$category = get_the_category(); echo $category[0]->slug;}elseif (is_page('top')) { echo "top"; }elseif (is_page('hasard')) { echo "hasard"; }?>">
    	<div class="loader <?php if (is_page('home')) { echo "home"; }elseif( is_category()){$category = get_the_category(); echo $category[0]->slug;}elseif( is_single()){$category = get_the_category(); echo $category[0]->slug;}elseif (is_page('top')) { echo "top"; }elseif (is_page('hasard')) { echo "hasard"; }?>">
		...
		<div class="pop-up <?php if (is_page('home')) { echo "home"; }elseif( is_category()){$category = get_the_category(); echo $category[0]->slug;}elseif( is_single()){$category = get_the_category(); echo $category[0]->slug;}elseif (is_page('top')) { echo "top"; }elseif (is_page('hasard')) { echo "hasard"; }?>">
